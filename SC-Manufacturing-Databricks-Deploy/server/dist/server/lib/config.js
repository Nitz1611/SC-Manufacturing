...
function resolveColumn(envKey, defaultName) {
...
export function periodSortColumn() {
    return quoteIdent(GOLD_NAMES.period);
}
export function weekExpression() {
...
export function buildRegionFilterSql(regionsCsv) {
    if (!regionsCsv)
        return '1=1';
...
export function loadQuerySql(queryKey) {
...
export function consoleDemoMode() {
    return String(process.env.CONSOLE_DEMO_MODE || '').toLowerCase() === 'true';
}
export function coarseCacheKey(params) {
